<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- SIM Number -->
        <div class="mt-4">
            <x-input-label for="sim_number" :value="__('SIM Number')" />
            <x-text-input id="sim_number" class="block mt-1 w-full" type="text" name="sim_number" :value="old('sim_number')" required autocomplete="sim_number" />
