        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <br>
                    <a href="{{ route('cars.create') }}" class="inline-flex items-center px-4 py-2 bg-green-600 border  rounded-md font-semibold text-xs text-black uppercase tracking-widest hover:bg-green-700 active:bg-green-900 focus:outline-none focus:border-green-900 focus:ring ring-green-300 disabled:opacity-25 transition ease-in-out duration-150">
                        Tambah Mobil Baru
                    </a>
                    <br>
                    <input type="text" id="searchInput" placeholder="Cari mobil..." class="border border-gray-300 rounded-md p-2">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 carList">
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">{{ $loop->index + 1 }}</div> <!-- Menampilkan nomor otomatis di sini -->
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
